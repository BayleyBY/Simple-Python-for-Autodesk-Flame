...
|--------|--------|----------|
| **Keep 9 (ISCI ID)** | 9 characters | (Older) ISCI ID format |
| **Keep 12 (AD-ID)** | 12 characters | Standard AD-ID format |
| **Remove Premiere XML Suffix** | Removes last 22 chars | Strips suffixes added by Premiere XML fixer tools |

## Usage

1. Select one or more clips in the Media Panel.
2. Right-click → **Rename... > Keep 9 (ISCI ID)**, **Keep 12 (AD-ID)**, or **Remove Premiere XML Suffix**
