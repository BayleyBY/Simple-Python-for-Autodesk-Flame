...
Description:
Color all segments containing a Timewarp timeline effect dark red. Gives a
quick visual overview of retimed shots during conform or finishing.

Menus:
Right-click a sequence in the Media Panel -> Sequence... -> Color Timewarped Shots
"""
