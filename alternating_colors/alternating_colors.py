"""
Script Name: Alternating Colors
...
Description:
    ...
    For any group of items selected in the Media Panel you can apply an alternating color scheme (light/dark versions of the color you select).
